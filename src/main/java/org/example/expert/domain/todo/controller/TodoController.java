...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoResponse>> getTodos(
            ...
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate updatedStartAt,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate updatedEndAt
    ) {
        return ResponseEntity.ok(todoService.getTodos(page, size, weather, updatedStartAt, updatedEndAt));
    }
